    ...
    <div className="min-h-screen bg-[#0A0E27] text-white p-4 sm:p-8 pb-20 space-y-8 antialiased">
      <div className="max-w-[1240px] mx-auto space-y-8">
        ...
        <header className="flex flex-col sm:flex-row justify-between items-start gap-4 border-b border-white/[0.06] pb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className={`px-4 py-2.5 rounded-[12px] text-sm font-semibold flex items-center gap-1.5 transition-all duration-200 border focus:outline-none focus:ring-2 focus:ring-[#0A84FF] ${
                showForm
        ...
        {/* ═══════════════════════════════════════════════
            ...
            ═══════════════════════════════════════════════ */}
        {notification && (
          <div className={`fixed bottom-6 right-6 z-50 px-5 py-3.5 rounded-[12px] text-white font-semibold text-sm flex items-center gap-2.5 backdrop-blur-md shadow-[0_12px_30px_rgba(0,0,0,0.5)] animate-[fadeIn_0.3s_ease-out] ${
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 divide-y lg:divide-y-0 lg:divide-x divide-white/[0.06]">
            ...
            <div className="pt-4 lg:pt-0 lg:pr-6 flex flex-col justify-between">
              ...
              <div className={`text-xs font-semibold mt-1 ${
                stats.balance >= 0 ? 'text-[#22D36A]' : 'text-[#FF4D6A]'
              }`}>
