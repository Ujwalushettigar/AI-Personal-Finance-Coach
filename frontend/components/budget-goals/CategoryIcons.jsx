...
/**
 * Category icon selector returning tailored monochrome/electric-blue SVG icons
 * No external icon library required.
 */
export function CategoryIcon({ category = '', className = 'w-5 h-5 text-blue-400' }) {
  ...
  if (norm.includes('entertain') || norm.includes('movie') || norm.includes('game') || norm.includes('fun')) {
    // Film / Entertainment
    return (
      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
